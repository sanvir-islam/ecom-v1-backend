import { type DefineOptions } from './metadata.js';
 ...
 * ```
 */
export declare function Define(options?: DefineOptions): (target: any, propertyKey: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
